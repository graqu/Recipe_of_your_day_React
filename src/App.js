...
function App() {
	...
	const [recipe, setRecipe] = useState([
		{ id: 1, title: 'Food 1', opened: false },
		{ id: 2, title: 'Food 2', opened: false },
	])
	//Temp State
	...
	const addRecipe = () => {
		if (newRecipe) {
			...
			let newEntry = { id: num, title: newRecipe, opened: false }
						...
						return (
							<React.Fragment key={item.id}>
								<div className="col itemBg">
									<div className={item.opened ? 'extended' : ''}>
